...
class LocomotiveEngineerTest < Minitest::Test
  ...
  # %w literal => shortcut to array notation, with no interpolation allowed. %W does allow that
  # %W[Leipzig Hannover Frankfurt#{1 + 1}]
  # ["Leipzig", "Hannover", "Frankfurt2"]
  # %w[Leipzig Hannover Frankfurt#{1 + 1}]
  # ["Leipzig", "Hannover", "Frankfurt\#{1", "+", "1}"]
