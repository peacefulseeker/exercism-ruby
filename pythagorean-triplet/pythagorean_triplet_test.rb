...
class PythagoreanTripletTest < Minitest::Test
  ...
  def test_several_matching_triplets
    expected = [[40, 399, 401], [56, 390, 394], [105, 360, 375], [120, 350, 370], [140, 336, 364], [168, 315, 357],
                [210, 280, 350], [240, 252, 348]]
    assert_equal expected, PythagoreanTriplet.triplets_with_sum(840)
  end

  def test_triplets_for_large_number
    expected = [[1200, 14_375, 14_425], [1875, 14_000, 14_125], [5000, 12_000, 13_000], [6000, 11_250, 12_750],
                [7500, 10_000, 12_500]]
